package zju.gis.zjh.service.Impl;
...
import zju.gis.zjh.dao.SuccesskilledDao;
import zju.gis.zjh.dao.cache.RedisDao;
...
import zju.gis.zjh.execption.SeckillException;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    // md5盐值字符串，用于混淆MD5
    private final String slat = "dsawff34/++/772fg657+-/*4186g43F$@";

    @Override
    public List<Seckill> getSeckillList() {
        return seckillDao.queryAll(0, 99);
    }
